...
<form class="layui-form">
	...
	<script type="text/html" id="userListBar">
		<shiro:hasPermission name="console:userAuthcDistribution">
			<a class="layui-btn layui-btn-xs layui-btn-warm" lay-event="distri">分配权限</a>
		</shiro:hasPermission>
	</script>
</form>
<script type="text/javascript" src="/resource/js/layui/layui.js"></script>
<script type="text/javascript" src="/resource/js/manager/authcDistribution.js"></script>
