...
layui.use(['form','jquery',"layer"],function() {
    ...
    function showNotice(){
        layer.open({
            ...
            '<p class="layui-red">程序猿正在加紧开发中，一切拭目以待吧！</span></p></div>',
    ...
    function lockPage(){
        layer.open({
            ...
            content : '<div class="admin-header-lock" id="lock-box">'+
                            ...
                            '<div class="admin-header-lock-name" id="lockUserName"><shiro:principal property="username"/></div>'+
                            '<div class="input_btn">'+
    ...
    $("body").on("click","#unlock",function(){
        if($(this).siblings(".admin-header-lock-input").val() == ''){
            ...
            $.ajax({
                url: "/console/unlock.shtml",
                dataType : "json",
                data: {lockPwd:$(this).siblings(".admin-header-lock-input").val()},
